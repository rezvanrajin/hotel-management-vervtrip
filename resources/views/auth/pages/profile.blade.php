                        ...
                        <form action="{{ route('admin.profile.update') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-floating mb-3 text-center">
                                <img class="border-redius-50 preview_img"
                                    src="{{ $user->profile_image ? asset('uploads/user-images/' . $user->profile_image) : asset('assets/img/no-img.jpg') }}"
                            ...
                            <div class="form-floating mb-3">
                                <input class="form-control" type="text" name="first_name"
                                    ...
                                    placeholder="{{ trans('language.label_first_name') }}" />
                                <label for="inputEmail">{{ trans('language.label_first_name') }}</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input class="form-control" type="text" name="last_name"
                                    value="{{ $user->last_name ?? '' }}"
                                    placeholder="{{ trans('language.label_last_name') }}" />
