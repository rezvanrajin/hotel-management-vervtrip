...
@section('content')
    ...
    <form class="w-100" action="{{ url('change-password') }}" method="post">
        ...
        {{-- <div class="form-floating mb-3"> --}}
            <input class="form-control" id="inputEmail" type="hidden" name="email"
        ...
        <div class="form-floating mb-3 position-relative">
            <input class="form-control" id="inputEmail" type="text" name="password" placeholder="{{ trans('language.label_new_password') }}" required />
        ...
        <div class="form-floating mb-3">
            <input class="form-control position-relative" id="inputEmail" type="text" name="password_confirmation" placeholder="{{ trans('language.label_confirm_password') }}" required />
