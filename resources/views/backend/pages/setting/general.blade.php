        ...
        <div class="my-2 card">
            ...
            <div class="card-body pb-0">
                <form action="{{ route('admin.setting.update') }}" id="settingForm" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        <label for="" class="col-sm-3 col-form-label">Minimum Wallet Amount (Birr):</label>
                        <div class="col-sm-9">
                            <input type="text" name="application_min_wallet_amount" value="{{ Helper::getSettings('application_min_wallet_amount') }}" class="form-control" placeholder="Minimum Wallet Amount" >
                        </div>
                    </div>
                    <div class="form-group row">
                        @php
