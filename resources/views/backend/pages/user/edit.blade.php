    ...
    <div class="modal-body">
                ...
                <div class="profile_image_input--container position-relative">
                    <label class="w-100 h-100 rounded-circle overflow-hidden bg-blue-100 cursor-pointer"
                        ...
                        <img class="w-100 h-100 object-fit-cover preview_image"
                            src="{{ $user->current_profile_image ? asset($user->current_profile_image) : asset('assets/img/ui/no-image.png') }}" alt="">
        ...
        <div class="row row-cols-2">
            <div class="form-group">
                <label for="" class="text-gray-700 fw-medium form-label">Full Name</label>
                <input type="text" name="name" value="{{ $user->name }}" class="form-control" placeholder="Name" >
            </div>
            <div class="form-group">
                <label for="" class="text-gray-700 fw-medium form-label">Phone No.</label>
                <input type="text" name="phone" value="{{ $user->phone }}" class="form-control" placeholder="Phone No." >
            </div>
        </div>
        <div class="form-group">
            <label for="" class="text-gray-700 fw-medium form-label">Full Name</label>
        ...
        <div class="row row-cols-2">
            <div class="form-group">
                <label for="" class="text-gray-700 fw-medium form-label">Email</label>
                <input type="text" name="email" value="{{ $user->email }}" class="form-control" placeholder="Email" required>
            </div>
            <div class="form-group">
                <label for="" class="text-gray-700 fw-medium form-label">Password</label>
                <input type="text" name="visible_password" value="{{ $user->visible_password }}" class="form-control" placeholder="Password" >
            </div>
        </div>
        <div class="row row-cols-2">
            <div class="form-group">
                <label for="" class="text-gray-700 fw-medium form-label">Gender</label>
            ...
            <div class="form-group">
                <label for="" class="text-gray-700 fw-medium form-label">Role</label>
        ...
        <div class="form-group">
            <label for="address" class="text-gray-700 2 col-form-label">Address</label>
            <textarea id="address" type="text" class="form-control h-auto resize-none" name="address" placeholder="Address"
