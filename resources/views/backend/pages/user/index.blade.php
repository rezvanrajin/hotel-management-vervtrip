...
@section('title', 'User | ' . Helper::getSettings('application_name') ?? 'Research')
@section('css')
    <style>
            ...
            <div class="card-body pb-0">
                <form method="" id="filter_form">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <select name="role" class="form-control" id="search_role" required>
...
@section('script')
    <script type="text/javascript">
        function getusers(name = null, email = null, phone = null, role = null) {
        ...
        $(document).on('click', '#filterBtn', function(e) {
            ...
            let role = $('#filter_form #search_role').val();

            $('#dataTable').DataTable().destroy();
            getusers(name, email, phone, role);
        })
