                        ...
                        <form action="{{ route('admin.profile.update') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="d-flex justify-content-center mb-3">
                                <label for="profile_image"
                                    class="rounded-circle overflow-hidden cursor-pointer position-relative profile-image-container">
                                    ...
                                    <div
                                        class="position-absolute start-0 end-0 top-0 bottom-0 flex-middle justify-content-center align-items-center profile-image-plus-icon">
